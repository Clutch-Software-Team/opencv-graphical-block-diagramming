const customNodes = [
    ...
    },
    {
        ...
        data: {
            ...
            returnValue: null,
            parameters: [
                { name: "H1", type: "Mat", required: true, currentValue: "", default: "" },
                { name: "H2", type: "Mat", required: true, currentValue: "", default: "" },
    ...
    },
    {
        ...
        data: {
            ...
            returnValue: null,
            parameters: [
                { name: "image", type: "Mat", required: true, currentValue: "", default: "" },
                { name: "contours", type: "MatOfArrays", required: true, currentValue: "", default: "" },
    ...
    },
    {
        ...
        data: {
            ...
            parameters: [
                ...
                { name: "kernel", type: "Mat", required: false, currentValue: "", default: "cv.Mat.eye(3, 3, cv.CV_32FC1)" },
    ...
    },
    {
        ...
        data: {
            ...
            parameters: [
                { name: "src", type: "Mat", required: true, currentValue: "", default: "" },
                { name: "dst", type: "Mat", required: false, currentValue: "", default: "" },
